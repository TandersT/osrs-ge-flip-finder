...
export const FLAG_DEFS: FlagDef[] = [
  ...
  },
  {
    key: 'fat',
    label: 'fat',
    title: 'Large margin — at least 10% post-tax ROI on the buy price',
    badgeClass: 'bg-amber-900/60 text-amber-300',
    textClass: 'text-amber-300',
    get: FLAG_GETTERS.fat,
  },
  {
    key: 'whale',
    label: 'whale',
    title: 'Huge margin — at least 25% post-tax ROI, a lot of money per gp risked',
    badgeClass: 'bg-yellow-900/60 text-yellow-300',
    textClass: 'text-yellow-300',
    get: FLAG_GETTERS.whale,
  },
  {
    key: 'prime',
    label: 'prime',
    title: 'A fat margin (≥10% ROI) with the hourly volume to actually fill it',
    badgeClass: 'bg-sky-900/60 text-sky-300',
    textClass: 'text-sky-300',
    get: FLAG_GETTERS.prime,
  },
  {
    key: 'stale',
    label: 'stale',
